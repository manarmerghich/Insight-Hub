# sentiment-word-cloud Specification

## Purpose
Donner une lecture rapide du vocabulaire réellement employé par les auteurs des messages, par catégorie de sentiment (positif/négatif/neutre) : les KPIs du dashboard résument le sentiment par des chiffres agrégés (score net, taux d'engagement, thèmes), mais aucun ne montre les mots qui reviennent le plus souvent dans les messages d'une catégorie donnée. Extraction et restitution visuelle, par catégorie de sentiment, des mots les plus fréquents parmi les messages déjà classés sous le scope du dernier run d'import et des filtres croisés actifs, sans nouveau calcul IA.
