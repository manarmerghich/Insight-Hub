# engagement-rate-by-sentiment Specification

## Purpose
Restituer, pour chaque catégorie de sentiment (positif/négatif/neutre) des messages classés du dernier run d'import, la moyenne des likes et la moyenne des retweets par message — afin de relier le sentiment mesuré au volume d'engagement réel, sans introduire de nouveau calcul IA.
