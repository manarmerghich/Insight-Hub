...
## Purpose
TBD - créé par le change enriched-pdf-export. Décrit l'export PDF du dashboard : déclenchement depuis le scope de filtres actif, et le contenu inclus (résumé exécutif en cache, score de sentiment net et son évolution, répartitions plateforme/pays, messages favoris du dernier import).
