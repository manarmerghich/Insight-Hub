# visitor-session-identity Specification

## Purpose
Attribuer et conserver, pour chaque visiteur anonyme, un identifiant de session propre — sans compte ni donnée d'identification personnelle — afin d'isoler les données de chaque visiteur (imports, dashboard, recherche, favoris, export PDF, résumé exécutif, comparaison de mots-clés) de celles des autres visiteurs.
